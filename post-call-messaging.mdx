...
- **Paid Tier:**
  - You can fully customize the message sent to your callers.
  - If you leave the message field empty, the default Voqo-branded message is used (same as Free Tier, and still free).
  - If you enter a custom message, your message is sent **exactly as written** (no Voqo branding or growth loop appended), and you are charged **20 credits** per SMS.
