...
## New Features
- **Contact-based Dynamic Start Sentence**: Paid users can now add a dynamic start sentence to each call, which is dynamically generated based on Custom Prompt's `Opening Sentence`, including the Contact's name.
